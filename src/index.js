...
let virtualKeyboard = {
  ...
  keySetup: [
    ...
    },
    {
      value: 'CAPSLOCK',
      shiftValue: 'CAPSLOCK',
      secondaryValue: 'CAPSLOCK',
      secondaryShiftValue: 'CAPSLOCK',
      code: 'CapsLock',
      isPressed: false,
    },
    {
  ...
  renderKeyboard() {
    this.keySetup.forEach((el) => {
      ...
      if (this.primaryLanguage) {
        key = new Key(this.shiftDown, el.value, el.shiftValue, el.isPressed).createKey();
      } else {
        key = new Key(this.shiftDown, el.secondaryValue, el.secondaryShiftValue, el.isPressed)
          .createKey();
      }
